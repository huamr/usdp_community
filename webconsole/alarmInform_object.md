...
通知对象，是USDP系统中，告警信息发送的目标用户，通知对象是由 [通知组](usdp_community/webconsole/alarmInform_group)  进行管理的；通知组再与 [告警模板](usdp_community/webconsole/alarmTemplate) 中的监控指标关联。
...
- [添加通知对象](usdp_community/webconsole/alarmInform_object?id=_1-添加通知对象)
- [管理通知对象](usdp_community/webconsole/alarmInform_object?id=_2-管理通知对象)
...
?> 参数说明：</br> - 自定义接口地址：请填写用于接收告警信息的服务所在"ip:port";
