...
- [Zookeeper服务相关组件管理](usdp_community/webconsole/service_component?id=zookeeper服务相关组件管理)
- [Zookeeper服务组件扩展](usdp_community/webconsole/service_component?id=zookeeper服务组件扩展)
...
该操作请参考 [为当前集群已使用的大数据服务扩展组件](usdp_community/webconsole/service_extension?id=_2-为当前集群已使用的大数据服务扩展组件) 操作。
