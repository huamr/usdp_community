...
- [添加大数据服务](usdp_community/webconsole/service_extension?id=_1-为当前集群添加大数据服务)
- [为已使用的大数据服务添加组件](usdp_community/webconsole/service_extension?id=_2-为当前集群已使用的大数据服务扩展组件)
